...
const Aurora = () => {
  ...
  const spinnerIndex = hilight(indexCode, language);
  const spinnerStyle = hilight(indexStyle, language);

  const pageCodeSnippets = [{ heading: "Page Component", content: pageCode,copyContent :code }];
  const auroraCodeSnippets = [
    { heading: "components/Spinner/index.jsx", content: spinnerIndex , copyContent :indexCode },
    { heading: "components/Spinner/style.module.scss", content: spinnerStyle,copyContent :indexStyle },
  ];
